...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      {/* Settings Form */}
      <div className="bg-surface-DEFAULT/80 rounded-xl border border-surface-border/70 p-6 space-y-6">
        {activeTab === 'general' && (
          <>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">平台名称</label>
                <input type="text" defaultValue="TestColony" className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50" />
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">默认语言</label>
                <select className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50">
                  <option>中文 (简体)</option>
              ...
              <div>
                ...
                <input type="number" defaultValue={5} className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50" />
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">Sub-Agent 最大嵌套深度</label>
                <input type="number" defaultValue={3} className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50" />
              </div>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="password" defaultValue="sk-••••••••••••••••" className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 font-mono focus:outline-none focus:border-violet-500/50" />
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">Base URL</label>
                <input type="text" defaultValue="https://api.deepseek.com/v1" className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 font-mono focus:outline-none focus:border-violet-500/50" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" defaultValue="localhost" className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50" />
              </div>
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">Port</label>
                <input type="number" defaultValue={5432} className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 focus:outline-none focus:border-violet-500/50" />
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'auth' && (
          <div className="space-y-4">
            <div>
              ...
              <input type="password" defaultValue="••••••••••••••••••••••••" className="w-full px-3 py-2 bg-surface-card/50 border border-slate-700 rounded-lg text-sm text-slate-200 font-mono focus:outline-none focus:border-violet-500/50" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
